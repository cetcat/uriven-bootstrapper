...
fn main() {
    ...
    if env::var_os("CARGO_CFG_WINDOWS").is_some() {
        ...
        res.set("FileDescription", "URIVEN Windows Bootstrapper");
        res.set("ProductName", "URIVEN Bootstrapper");
        res.set("ProductVersion", env!("CARGO_PKG_VERSION"));
        res.set("InternalName", "URIVEN Bootstrapper");
        res.set("OriginalFilename", "UrivenPlayerLauncher.exe");
        res.set("CompanyName", "URIVEN Corporation");
