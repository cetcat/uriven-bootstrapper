...
del target\i686-pc-windows-msvc\release\UrivenPlayerLauncher.exe
...
ren target\i686-pc-windows-msvc\release\syntax_bootstrapper.exe UrivenPlayerLauncher.exe